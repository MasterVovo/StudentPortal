<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        FROM stdinfo LEFT JOIN tblgrades ON stdinfo.stdID = tblgrades.studentId 
        AND tblgrades.subjectCode = ? LEFT JOIN thrassign ON 
        stdinfo.stdSection = thrassign.sectionName WHERE stdinfo.stdSection = ? 
        AND thrassign.thrId = ?";
